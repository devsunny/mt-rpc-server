...
public class RPCWorkerTest implements RPCWorkerInterface {

	public List<RPCObject> execute(List<RPCObject> args) throws Exception {
		
		List<RPCObject> objs = new ArrayList<RPCObject>();		
		objs.add(RPCObject.newInstance(RPCEnvelope.RPC_OBJECT_TYPE_COLLECTION_STRING).setValue("This is returned from server execution"));
		return objs;
	}
